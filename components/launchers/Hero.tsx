...
const Hero: React.FC<HeroProps> = ({ backgroundImage, title, subtitle }) => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="p-5">
          <h2 className="text-6xl sm:text-8xl  text-white pb-2 font-extrabold text-center">
            {title}
          </h2>
          <h2 className="text-xl sm:text-2xl text-center text-white pb-2 font-semibold">
            {subtitle}
          </h2>
        </div>
      </motion.div>
